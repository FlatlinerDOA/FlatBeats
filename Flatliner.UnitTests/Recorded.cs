namespace Flatliner.UnitTests
{
    ...
    public struct Recorded<T> : IEquatable<Recorded<T>>
    {
        ...
        {
            return this.Time == other.Time && EqualityComparer<T>.Default.Equals(this.Value, other.Value);
        }
        ...
        {
            return this.Value.ToString() + "@" + this.Time.ToString(CultureInfo.CurrentCulture);
        }
    }
}