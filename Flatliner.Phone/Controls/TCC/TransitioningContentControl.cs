...
namespace System.Windows.Controls
{
    ...
    public class TransitioningContentControl : ContentControl
    {
        ...
        private readonly List<PageTransitionMapping> mappings = new List<PageTransitionMapping>();
        public List<PageTransitionMapping> PageTransitionMappings { get { return this.mappings; } }
        ...
        private static void OnIsTransitioningPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!source._allowIsTransitioningWrite)
            {
                ...
                throw new InvalidOperationException(Flatliner.Phone.Properties.Resources.TransitiotioningContentControl_IsTransitioningReadOnly);
            }
        }
        ...
        private Storyboard CurrentTransition
        {
            ...
            set
            {
                ...
                {
                    this.currentTransition.Completed -= OnTransitionCompleted;
                }
            ...
            if (newStoryboard == null)
            {
                ...
                else
                {
                    ...
                    throw new ArgumentException(
                        string.Format(CultureInfo.CurrentCulture, Flatliner.Phone.Properties.Resources.TransitioningContentControl_TransitionNotFound, newTransition));
                }
            }
            else
            {
        ...
        private string standardTransition;
        /// <summary>
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (transition == null)
            {
                ...
                throw new ArgumentException(
                    string.Format(CultureInfo.CurrentCulture, Flatliner.Phone.Properties.Resources.TransitioningContentControl_TransitionNotFound, invalidTransition));
            }
            this.standardTransition = Transition;
            ...
            if (CurrentContentPresentationSite != null && PreviousContentPresentationSite != null)
            {
                ...
                if (!IsTransitioning || RestartTransitionOnContentChange)
                {
                    ...
                    if (transitionMapping != null)
                    {
                        ...
                        Transition = this.standardTransition;
