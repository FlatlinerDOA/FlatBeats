namespace Flatliner.Phone
{
    ...
    public class DelegateCommand : ICommand
    {
        ...
        /// </summary>
        private readonly ExclusiveSection isRaisingCanExecuteChanged = new ExclusiveSection();

        private void OnCanExecuteChanged()
        {
            if (!this.isRaisingCanExecuteChanged.TryEnter())
            {
                return;
            }
            ...
            this.isRaisingCanExecuteChanged.ExitClean();
        }
