namespace FlatBeats.Controls
{
    ...
    public class ApplicationBarBinder : IDisposable
    {
        ...
        /// Initializes a new instance of the ApplicationBarBinder class.
        /// </summary>
        public ApplicationBarBinder(PhoneApplicationPage page, IApplicationBarViewModel viewModel) : this(page)
        {
        ...
        private void AddApplicationBarButton(ICommandLink commandLink)
        {
            ...
            {
                IconUri = new Uri(commandLink.IconUri, UriKind.RelativeOrAbsolute),
